...
if(isset($_POST['s'])){
	$stmt2 = $conn->prepare("update users set is_activated = true where id_user = ?") ;
	$stmt2->bind_param("s",$_POST['h']);
	$stmt2->execute();
}
...
<?php
	...
	$stmt = $conn->query("SELECT * FROM users where is_activated = false");
...
?>
		...
		<div class="w3-twothird w3-container">
		  ...
		  <p>username: <?php echo $row['username']; ?><br/>email: <?php echo $row['email'];  ?><br/>country: <?php echo $row['country'] ; ?><br/></p>
		</div>
