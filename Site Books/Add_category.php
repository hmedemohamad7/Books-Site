...
if(isset($_POST['add_req_cat'])){
	$stmt = $conn->prepare("insert into categories(name_category,EEE) values(?,?)") ;
	$nc = $_POST['ttt'] ;
	$id = $_SESSION['login']['id_user'];
	$stmt->bind_param("si",$nc,$id);
	$stmt->execute();
...
<div class="w3-main" style="margin-left:250px">
		...
		<input type=submit name=add_req_cat value="category request"/>
		</p>
